...
export function PropertyRegistration({ onSuccess }: PropertyRegistrationProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6 bg-slate-50 dark:bg-[#1a1a1a] text-slate-900 dark:text-slate-100">
      <div className="text-center">
        <h1 className="text-3xl font-bold mb-2 text-slate-900 dark:text-white">Register Your Property</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="title" className="text-slate-900 dark:text-white">Property Title *</Label>
                <Input
                  id="title"
                  value={formData.title}
                  onChange={(e) => updateFormData('title', e.target.value)}
                  placeholder="e.g., Downtown Office Complex"
                  className={`bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:border-blue-500 dark:focus:border-blue-400 ${errors.title ? 'border-red-500 dark:border-red-500' : ''}`}
                />
              ...
              <div>
                ...
                <Select value={formData.propertyType} onValueChange={(value) => updateFormData('propertyType', value)}>
                  <SelectTrigger className={`bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white focus:border-blue-500 dark:focus:border-blue-400 ${errors.propertyType ? 'border-red-500 dark:border-red-500' : ''}`}>
                    <SelectValue placeholder="Select property type" />
                  </SelectTrigger>
                  <SelectContent className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                    {propertyTypes.map(type => (
                      <SelectItem key={type} value={type} className="text-slate-900 dark:text-white">{type}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
            ...
            <div>
              ...
              <Textarea
                ...
                rows={4}
                className={`bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:border-blue-500 dark:focus:border-blue-400 ${errors.description ? 'border-red-500 dark:border-red-500' : ''}`}
              />
        ...
        <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
          ...
          <CardContent className="space-y-4">
            <div>
              <Label htmlFor="address" className="text-slate-900 dark:text-white">Street Address *</Label>
              <Input
                id="address"
                value={formData.address}
                onChange={(e) => updateFormData('address', e.target.value)}
                placeholder="123 Main Street"
                className={`bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:border-blue-500 dark:focus:border-blue-400 ${errors.address ? 'border-red-500 dark:border-red-500' : ''}`}
              />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <Label htmlFor="city" className="text-slate-900 dark:text-white">City *</Label>
                <Input
                  id="city"
                  value={formData.city}
                  onChange={(e) => updateFormData('city', e.target.value)}
                  placeholder="New York"
                  className={`bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:border-blue-500 dark:focus:border-blue-400 ${errors.city ? 'border-red-500 dark:border-red-500' : ''}`}
                />
                {errors.city && <p className="text-sm text-red-500 mt-1">{errors.city}</p>}
              </div>

              <div>
                <Label htmlFor="state" className="text-slate-900 dark:text-white">State *</Label>
                <Input
                  id="state"
                  value={formData.state}
                  onChange={(e) => updateFormData('state', e.target.value)}
                  placeholder="NY"
                  className={`bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:border-blue-500 dark:focus:border-blue-400 ${errors.state ? 'border-red-500 dark:border-red-500' : ''}`}
                />
                {errors.state && <p className="text-sm text-red-500 mt-1">{errors.state}</p>}
              </div>

              <div>
                <Label htmlFor="zipCode" className="text-slate-900 dark:text-white">ZIP Code *</Label>
                <Input
                  id="zipCode"
                  value={formData.zipCode}
                  onChange={(e) => updateFormData('zipCode', e.target.value)}
                  placeholder="10001"
                  className={`bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:border-blue-500 dark:focus:border-blue-400 ${errors.zipCode ? 'border-red-500 dark:border-red-500' : ''}`}
                />
        ...
        <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="totalValue" className="text-slate-900 dark:text-white">Total Property Value (USD) *</Label>
                <Input
                  id="totalValue"
                  type="number"
                  ...
                  placeholder="1000000"
                  className={`bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:border-blue-500 dark:focus:border-blue-400 ${errors.totalValue ? 'border-red-500 dark:border-red-500' : ''}`}
                />
                {errors.totalValue && <p className="text-sm text-red-500 mt-1">{errors.totalValue}</p>}
              </div>

              <div>
                <Label htmlFor="totalShares" className="text-slate-900 dark:text-white">Total Token Shares *</Label>
                <Input
                  id="totalShares"
                  type="number"
                  ...
                  placeholder="1000"
                  className={`bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:border-blue-500 dark:focus:border-blue-400 ${errors.totalShares ? 'border-red-500 dark:border-red-500' : ''}`}
                />
        ...
        <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
          ...
          <CardContent className="space-y-4">
            <div className="border-2 border-dashed border-slate-300 dark:border-slate-600 rounded-lg p-6 text-center bg-slate-50 dark:bg-slate-700/30">
              <Upload className="h-12 w-12 mx-auto text-slate-400 dark:text-slate-500 mb-4" />
              <div className="space-y-2">
                <Label htmlFor="documents" className="text-lg font-medium cursor-pointer text-slate-900 dark:text-white">
                ...
                {formData.documents.map((file, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-slate-100 dark:bg-slate-700 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-sm text-slate-900 dark:text-white">{file.name}</p>
          ...
          <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
            <CardContent className="pt-6">
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between text-sm mb-2 text-slate-900 dark:text-white">
        ...
        <div className="flex justify-end">
          <Button
            ...
            className="px-8 py-2 bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white"
          >
            {isSubmitting ? (
              <>
